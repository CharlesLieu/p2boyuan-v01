...
class InspectionSubmitRequest extends FormRequest
{
    ...
    {
        return [
            'inspectionResult' => ['required', 'string', 'in:PASS,FAIL'],
            'inspectionNote' => ['required', 'string', 'max:4000'],
